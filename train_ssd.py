...
def train(loader, net, criterion, optimizer, device, debug_steps=100, epoch=-1):
    ...
    for i, data in enumerate(loader):
        ...
        if i and i % debug_steps == 0:
            ...
            trainrow = [epoch, avg_loss, avg_reg_loss, avg_clf_loss]
            trainwriter.writerow(trainrow)
...
if __name__ == '__main__':
    ...
    traincsv = open('train', 'w')
    testcsv = open('test' , 'w')
    
    trainwriter = csv.writer(traincsv)
    testwriter = csv.writer(testcsv)
    
    trainHeader =['Epoch','Avg Loss','Avg Regression Loss','Avg Classification Loss']
    testHeader = ['Epoch','Validation Loss', 'Validation Regression Loss', 'Validation Classification Loss']
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            testrow = [epoch, val_loss, val_regression_loss, val_classification_loss]
